First upload .ino file to your arduino mega. (notice that the normal arduino don't have enought anolog input, so you need an anolog to digital converter or simply just use mega.)
